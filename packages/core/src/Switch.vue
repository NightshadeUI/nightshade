...
.Switch {
    ...
    --Switch-outline-focus-color: var(--color-primary);
...
.Switch:not(:disabled):focus, .Switch.Switch-pseudo-focus {
    z-index: 10;
    --Switch-outline-color-effective: var(--Switch-outline-focus-color);
}
...
.Switch-default {
    ...
    --Switch-outline-focus-color: var(--color-default-focus);
}
...
.Switch-primary {
    ...
    --Switch-outline-focus-color: var(--color-primary-focus);
}
...
.Switch-secondary {
    ...
    --Switch-outline-focus-color: var(--color-secondary-focus);
}
...
.Switch-tertiary {
    ...
    --Switch-outline-focus-color: var(--color-tertiary-focus);
}
...
.Switch-mono {
    ...
    --Switch-outline-focus-color: var(--color-mono-focus);
}
...
.Switch-success {
    ...
    --Switch-outline-focus-color: var(--color-success-focus);
}
...
.Switch-warning {
    ...
    --Switch-outline-focus-color: var(--color-warning-focus);
}
...
.Switch-danger {
    ...
    --Switch-outline-focus-color: var(--color-danger-focus);
}
</style>
